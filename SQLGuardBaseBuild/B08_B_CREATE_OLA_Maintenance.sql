...
-------------This script may not need to be executed if a OLA backups are not required.------

*/

USE [SQLGuard_Ops] -- Specify the database in which the objects will be created, don't install into MASTER.
